...
internal sealed class AnalysisBarReadout : IPointerReadoutTarget
{
    private AnalysisBarReadout(
        double position,
        double valueBase,
        double value,
        double size,
    ...
    public static AnalysisBarReadout FromBar(
        Bar bar,
        string header,
        IReadOnlyList<CursorReadoutLine> lines)
    {
        return new AnalysisBarReadout(
            bar.Position,
            bar.ValueBase,
            bar.Value,
            bar.Size,
