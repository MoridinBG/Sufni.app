...
public abstract record SessionMobileLoadResult
{
    ...
    public sealed record LoadedFromCache(SessionCachePresentationData Data) : SessionMobileLoadResult;
    public sealed record BuiltCache(SessionCachePresentationData Data) : SessionMobileLoadResult;
