...
public class LinearSensorConfigurationViewTests
{
    [AvaloniaFact]
    public async Task LinearSensorConfigurationView_NumericInputs_DisplayBoundValues()
    {
        var view = new LinearSensorConfigurationView
        {
