...
[Collection("Ui")]
public class ExtensionSeriesGraphViewTests
{
    [AvaloniaFact]
    public async Task BindingNeutralViewModel_PropagatesTimelineAndShowAirtimeToInheritedProperties()
    {
        ...
        var viewModel = CreateViewModel(airtimeSpans: [new RecordedSessionGraphSpan(1, 2)]);
        viewModel.Timeline = timeline;
        var view = new ExtensionSeriesGraphView { DataContext = viewModel };
    ...
    {
        var view = new ExtensionSeriesGraphView { DataContext = CreateViewModel() };
    ...
    private static RecordedSessionSeriesGraphViewModel CreateViewModel(
        ...
        new(
            [new RecordedSessionGraphSeries(
                RecordedSessionGraphSeriesRole.SuspensionFront, "Front", "mm", [0, 1, 2], [10, 20, 15])],
