...
public class SelectableAnalysisPlotTests
{
    [Fact]
    public void SelectableAnalysisBarHitTester_InsidePointReturnsBarAndOutsidePointsReturnFalse()
    {
        var sut = new SelectableAnalysisBarHitTester();
        var first = new Bar
        {
            Position = 10,
            Size = 4,
    ...
    [Fact]
    public void SelectableAnalysisBarHitTester_VerticalBarAtXReturnsVisibleBarAndIgnoresGapsAndEmptyBars()
    {
        var sut = new SelectableAnalysisBarHitTester();
        var visible = new Bar
        {
    ...
    public void VelocityDistribution_SelectedAllTravelBucketsHighlightsPrimarySegmentsInBin()
    {
        ...
        sut.SetActiveAnalysisSelection(
    ...
    public void StrokeLengthDistribution_SelectedPrimaryBarReturnsStrokeLengthSelection()
    {
        ...
        var plot = new Plot();
        var sut = new StrokeLengthDistributionPlot(plot, SuspensionType.Front, BalanceType.Compression);
        sut.LoadTelemetryData(telemetry);
    ...
    public void StrokeSpeedDistribution_SelectedPrimaryBarReturnsStrokeSpeedSelectionWithClickedBounds()
    {
        ...
        var index = FindPositiveIndex(data);
        var plot = new Plot();
        var sut = new StrokeSpeedDistributionPlot(plot, SuspensionType.Front, BalanceType.Compression);
        sut.LoadTelemetryData(telemetry);
    ...
    public void DeepTravelDistribution_SelectedPrimaryBarReturnsDeepTravelSelectionWithClickedBounds()
    {
        ...
        var index = FindPositiveIndex(data);
        var plot = new Plot();
        var sut = new DeepTravelDistributionPlot(plot, SuspensionType.Front);
        sut.LoadTelemetryData(telemetry);
    ...
    public void StrokeSpeedDistribution_SelectedPrimaryBarReceivesHighlightedOutline()
    {
        ...
        sut.SetActiveAnalysisSelection(selection);
